...
- import csv — loads CSV file reading (already in your Week 6 notes)
...
i → the index number (0, 1, 2, 3...)
row → the actual item at that position
useful when you need to know both where you are AND what you're looking at

Break

break — immediately exits the loop, stops running it entirely
...
dpi=150 — resolution, dots per inch — higher = sharper, 150 is good for slides
